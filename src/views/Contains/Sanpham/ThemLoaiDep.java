 ...
 * @author duong
 */
public class ThemLoaiDep extends javax.swing.JFrame {

    LoaiDepService sv = new LoaiDepServiceImpl();
    ...
    public void fillTable() {
        List<LoaiDep> list = sv.getAll();
        DefaultTableModel dtm = (DefaultTableModel) tblLoaiDep.getModel();
        dtm.setRowCount(0);
        for (LoaiDep x : list) {
    ...
    private void initComponents() {
        ...
        tblLoaiDep = new javax.swing.JTable();
        ...
        jLabel1.setText("Thêm loại dép");

        tblLoaiDep.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        tblLoaiDep.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblLoaiDepMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblLoaiDep);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        LoaiDep c = new LoaiDep(0, ma, ten);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        int index = this.tblLoaiDep.getSelectedRow();
        if(index == -1){
            return;
        }
        LoaiDep c = sv.getAll().get(index);
    ...
    private void tblLoaiDepMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblLoaiDepMouseClicked
        int index = this.tblLoaiDep.getSelectedRow();
        if(index == -1){
            return;
        }
        list = this.sv.getAll();
        LoaiDep c = list.get(index);
        txtMa.setText(c.getMa());
        txtTen.setText(c.getTen());
    }//GEN-LAST:event_tblLoaiDepMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemLoaiDep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tblLoaiDep;
