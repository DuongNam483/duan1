 ...
 * @author duong
 */
public class ThemDep extends javax.swing.JFrame {

    DepService sv = new DepServiceimpl();
    ...
    public void fillTable() {
        List<Dep> list = sv.getAll();
        DefaultTableModel dtm = (DefaultTableModel) tblDep.getModel();
        dtm.setRowCount(0);
        for (Dep x : list) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        int index = this.tblDep.getSelectedRow();
        if(index == -1){
            return;
        }
        Dep c = sv.getAll().get(index);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemDep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
