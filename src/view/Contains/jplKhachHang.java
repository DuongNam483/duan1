...
public class jplKhachHang extends javax.swing.JPanel {
    ...
    private KhachHangService sv = new KhachHangServiceImpl();
...
//    }
    ...
    public String validated(int id, String ma, String ten, String email, String sdt, String diaChi) {
...
//        System.out.println(ld1);
        ...
        String diaChi = txtDiaChi.getText();
        String check = validated(0, ma, ten, email, sdt, diaChi);
        if (!check.equals("")) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        boolean gioiTinh = rdoNam.isSelected() ? true : false;
        String diaChi = txtDiaChi.getText();
        String check = validated(id, maNV, ten, email, sdt, diaChi);
        if (!check.equals("")) {
            JOptionPane.showMessageDialog(this, check);
            return;
        }
    ...
    private void txtTimKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKeyReleased
        String tim = this.txtTim.getText();
        if(tim.trim().isBlank()){
            JOptionPane.showMessageDialog(this, "Vui lòng nhập tên muốn tìm.");
            return;
        }
        listNV = sv.getByTen(tim);
        dtm.setRowCount(0);
        for(KhachHang x : listNV){
            Object[] rowdata = new Object[]{
                x.getMa(),
